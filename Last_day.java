...
public class Last_day extends JFrame{

	public Last_day(String title)
	{
		super(title);
		JLabel l1,l2,l3;
		...
		l3=new JLabel("Selling details of last day");
		...
		for(Products re:list)
		{
			...
			{   
				...
				if(values[i].equals(data[r][0])&& s3.equals(data1[r1][1]))
				{
